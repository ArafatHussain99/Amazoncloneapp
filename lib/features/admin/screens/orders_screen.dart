...
import 'package:amazon_clone_tutorial/features/auth/widgets/single_product.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  void reqOrders(BuildContext context) async {
    ...
    return orderList == null
        ...
        : GridView.builder(
            ...
            itemBuilder: (context, item) {
              final orderData = orderList![item];
              return GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, OrderDetailScreen.rouneName,
                      arguments: orderData);
                },
                child: SizedBox(
                  height: 140,
